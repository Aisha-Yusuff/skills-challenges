...
it "list out the entries added" do 
  ...
  describe "word counting behaviour" do
    it "counts the words in all the entries" do
      diary = Diary.new 
      diary_entry_1 = DiaryEntry.new("my title", "my contents")
      diary_entry_2 = DiaryEntry.new("my title 2", "my contents 2")
      diary.add(diary_entry_1)
 ...
 describe "reading time behaviour" do
  ...
  it "calcualtes the reading time for all entries, where it fits exactly" do
    diary = Diary.new 
    ...
    it "calcualtes the reading time for all entries, where it falls over the minute for wpm" do
      diary = Diary.new 
      diary_entry_1 = DiaryEntry.new("my title", "my contents")
      diary_entry_2 = DiaryEntry.new("my title 2", "my contents 2")
      diary.add(diary_entry_1)
  ...
  describe " best reading time entry behaviour" do
    ...
    context "where we just have one entry and it is readable within the time given" do
    ...
    context "where we just have one entry and it is unreadable within the time" do
      it "returns nil" do 
        diary = Diary.new 
